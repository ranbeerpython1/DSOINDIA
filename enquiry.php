...
<tr><td class="headingText">PLAYER REGISTRATION FORM</td></tr>
<tr><td class="paraText" width="900px">
<table cellpadding="0" cellspacing="0" width="900px">
<td><table border="0"; width="600px" height="500px" align="center" >
<?php
...
<tr><td class="lefttxt">Age:</td><td><input type="number" name="t4" required pattern="[1 _]{1,20}" title"Please Enter Only numbers between 1 to 20 for Age"/></td><td><br/><tr><td class="lefttxt">Date of Birth</td><td><input type="text" name="t2" required pattern="[0-9]{10,12}" title"Please Enter Only numbers between 10 to 12 for D.O.B."/></td></tr><br/>
...
<tr><td class="lefttxt">No.of Player:</td><td><input type="number" name="t5" required pattern="[1 _]{1,10}" title"Please Enter Only numbers between 1 to 15 for Player"/></td><td><br/>
<tr><td class="lefttxt">T-ShirtSize:</td><td><input type="text" name="t6" required pattern="[XS, S, M, L, XL, XXL]" title"Please Enter Only Characters and numbers between 1 to 20 for T-ShirtSize"/></td><td><br/>
